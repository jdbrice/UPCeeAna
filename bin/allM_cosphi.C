...
void allM_cosphi( string n = "Run10AuAu.root" ){

	TFile *f = new TFile( n.c_str() );

	TH1 * h1=(TH1*)f->Get("wdeltaPhi_pd1_fold_all");
	TH1 * h0 = (TH1*)h1->Clone("h0");
	TH1 * h3=(TH1*)f->Get("wdeltaPhi_pd1_2fold_all");
	...
	c2->Print( "cos4phi_allM.png" );
	c2->Print( "/Users/jdb/notable/attachments/upcee_deltaPhi_foldpi2_allM.png" );
	...
	c4->Print( "/Users/jdb/notable/attachments/upcee_deltaPhi_foldpi4_allM.png" );
	...
	c5->Print( "/Users/jdb/notable/attachments/upcee_deltaPhi_foldpi4_frac_allM.png" );
