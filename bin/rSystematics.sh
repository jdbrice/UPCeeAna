...
# echo "ver = _DTOF8_PID2"
# ./pico.app config/ana.xml --p.XeeXpipi=0 --p.XeeCut=2 --p.dTofCut=0.8 --ver=_DTOF8_PID2 >& out/log_DTOF8_PID2.log &

# echo "ver = _DTOF2"
# ./pico.app config/ana.xml --p.XeeXpipi=3 --p.XeeCut=10 --p.dTofCut=0.2 --ver=_DTOF2 >& out/log_DTOF2.log &
